package com.pitoftheshadowlord.j2dgame.input;

/**
 * Not sure where I got this class from, very useful for describing
 * input actions.
 *
 * @author unknown
 *
 */
public class JGInput {
     ...
     */
    public JGInput(String name, int behavior) {
        this.name = name;
